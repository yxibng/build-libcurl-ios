...
function build_for_arch() {
  ...
  ./configure --disable-shared --enable-symbol-hiding --without-ssl --with-secure-transport --without-zlib --enable-static --enable-ipv6  --host="${HOST}" --prefix=${PREFIX} && make -j8 && make install
}
